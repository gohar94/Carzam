...
aws ec2 create-key-pair --key-name aws-key --query 'KeyMaterial' --output text > ~/Desktop/deep_learning/gohar-aws.pem 
chmod 400 ~/Desktop/deep_learning/gohar-aws.pem
...
echo Connect: ssh -i ~/Desktop/deep_learning/gohar-aws.pem ubuntu@$instanceUrl
